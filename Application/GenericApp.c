...
void GenericApp_Init( uint8 task_id )
{
  ...
  LREP("GENERICAPP_ENDPOINT: %d",GENERICAPP_ENDPOINT);
...
#if defined (ROUTER)
    char theMessageData[] = "data sent by the router \n";
    GenericApp_DstAddr.addrMode = (afAddrMode_t)afAddr16Bit;
    GenericApp_DstAddr.endPoint = DEVICE_ENDPOINT;
    GenericApp_DstAddr.addr.shortAddr = 1;
#elif defined (END_DEVICE)
    char theMessageData[] = "data sent by the end-device \n";
    // GenericApp_DstAddr.addrMode = (afAddrMode_t)af;
    // GenericApp_DstAddr.endPoint = ROUTER_ENDPOINT;
    // GenericApp_DstAddr.addr.shortAddr = 1;

#else 
    //GenericApp_DstAddr.addrMode = (afAddrMode_t)afAddrNotPresent;
    char theMessageData[] = "data sent by the coordinator \n";
#endif
  //GenericApp_DstAddr.addr.shortAddr = 0;
  //GenericApp_DstAddr.addrMode = (afAddrMode_t)afAddrNotPresent;
